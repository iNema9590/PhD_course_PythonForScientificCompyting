...
filehandler = filehandling.OdeFileHandler(directory)
plotter = plot.OdePlotter("Case 1")

print("Initiated Case # 1 ...\n")

sol = solver.OdeSolver(10, 8 / 3, 6)
n = 10000
t = 0.02
...
print("Writing...")
st = time.time()
filehandler.ode_solver_writer(sol.to_string(), "ode_solver.txt")
filehandler.ode_data_writer(result, "ode_result.txt")
et = time.time()
print("Time elapsed: %0.3f ms" % ((et - st) * 1000.0))
...
filehandler.ode_plot_figure_saver(plot_color, "plot_3d_color.png")
et = time.time()
print("Time elapsed: %0.3f ms" % ((et - st) * 1000.0))
...
filehandler.ode_plot_figure_saver(plot_color, "plot_2d_xy_color.png")
et = time.time()
print("Time elapsed: %0.3f ms" % ((et - st) * 1000.0))
...
filehandler.ode_plot_figure_saver(plot_color, "plot_2d_xz_color.png")
et = time.time()
print("Time elapsed: %0.3f ms" % ((et - st) * 1000.0))
...
filehandler.ode_plot_figure_saver(plot_color, "plot_2d_yz_color.png")
et = time.time()
print("Time elapsed: %0.3f ms" % ((et - st) * 1000.0))
